...
You can also use python changeOpenlayersColor.py --output-png colordir color or ./changeOpenlayersColor.py --output-png colordir color depending on your OS and
your dir permissions. In this case, it will create a new dir and put the png image into it.
